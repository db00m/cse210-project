    ...
    def set_scene(self):
        ...
        def place_objects(
            ...
            for _ in range(number):
                ...
                object.set_texture(
                    texture
                )  # In the future their will be diffrent types of gems/items
                while not placed:
                    # Randomly position
        ...
        for _ in range(constants.ITEMS):
            ...
            while not placed:
                ...
                item.center_x = random.randrange(
                    (constants.MAZE_WIDTH) * constants.ITEM_CONSTANT
                )
                item.center_y = random.randrange(
                    (constants.MAZE_HEIGHT) * constants.ITEM_CONSTANT
                )
